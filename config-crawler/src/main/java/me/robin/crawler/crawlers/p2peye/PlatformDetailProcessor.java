...
public class PlatformDetailProcessor extends RegexProcessor {
    ...
    public MatchOther processPage(Page page) {
        ...
        page.getRequest().getExtras().forEach(request::putExtra);
        ...
        request.putExtra(Param.plat.onlinetime, time);
        ...
        request.putExtra(Param.plat.projecttype, StringUtils.replace(assetsType, " | ", "|"));
